...
docs/
  ...
  operators/
    concepts/
      _category_.json
      operator-introduction.md
      operator-keys.md
    howto/
      managekeys/
        _category_.json
        institutional-operators.md
        solo-operators.md
      _category_.json
      avs-operator-risks-mitigations-bp.md
      operator-content-guidelines.md
      operator-installation.md
      operator-rewards-config.md
      operator-sets.md
      troubleshooting.md
    operator-guides/
      _category_.json
  ...
  restakers/
    concepts/
      _category_.json
      native-restaking-withdrawal-delays.md
      overview.md
    restaking-guides/
      0-restaking-user-guide/
        liquid-restaking/
          _category_.json
          restake-lsts.md
          withdraw-from-eigenlayer.md
        native-restaking/
          _category_.json
          README.md
        restaker-delegation/
          _category_.json
          delegate-to-an-operator.md
          redelegation-process.md
          undelegate-from-an-operator-and-initiate-withdrawal.md
        _category_.json
      testnet/
        1-restaking-developer-guide.md
        obtaining-testnet-eth-and-liquid-staking-tokens-lsts.md
        README.md
      _category_.json
      1-restaking-developer-guide.md
    _category_.json
...
## File: docs/eigenlayer/archived/_category_.json
````json
{
  "position": 13,
  "label": "Archived"
...
## File: docs/eigenlayer/archived/arhived-slashing.md
````markdown
---
sidebar_position: 1
...
## File: docs/lib/RenderMarkdown.tsx
````typescript
...
## File: docs/operators/concepts/_category_.json
````json
{
  "position": 1,
  "label": "Concepts"
...
## File: docs/operators/concepts/operator-introduction.md
````markdown
---
sidebar_position: 1
title: Overview
...
## File: docs/operators/concepts/operator-keys.md
````markdown
---
sidebar_position: 4
title: Operator Keys
...
## File: docs/operators/howto/managekeys/_category_.json
````json
{
  "position": 4,
  "label": "Manage keys"
...
## File: docs/operators/howto/managekeys/institutional-operators.md
````markdown
---
sidebar_position: 2
...
## File: docs/operators/howto/managekeys/solo-operators.md
````markdown
---
sidebar_position: 3
id: solo-stakers
...
## File: docs/operators/howto/_category_.json
````json
{
  "position": 1,
  "label": "How To"
...
## File: docs/operators/howto/avs-operator-risks-mitigations-bp.md
````markdown
---
sidebar_position: 5
...
## File: docs/operators/howto/operator-content-guidelines.md
````markdown
---
sidebar_position: 6
...
## File: docs/operators/howto/operator-installation.md
````markdown
---
sidebar_position: 1
...
## File: docs/operators/howto/operator-rewards-config.md
````markdown
---
sidebar_position: 3
...
## File: docs/operators/howto/operator-sets.md
````markdown
---
sidebar_position: 2
...
## File: docs/operators/howto/troubleshooting.md
````markdown
---
sidebar_position: 7
title: Troubleshoot
...
## File: docs/operators/operator-guides/_category_.json
````json
{
  "position": 1,
  "label": "Operator"
...
## File: docs/operators/reference/_category_.json
````json
{
  "position": 3,
  "label": "Reference"
...
## File: docs/operators/reference/operator-faq.md
````markdown
---
sidebar_position: 7
title: Operator FAQ
...
## File: docs/operators/_category_.json
````json
{
  "position": 2,
  "label": "Operators"
...
## File: docs/restakers/concepts/_category_.json
````json
{
  "position": 1,
  "label": "Concepts"
...
## File: docs/restakers/concepts/native-restaking-withdrawal-delays.md
````markdown
---
sidebar_position: 2
...
## File: docs/restakers/concepts/overview.md
````markdown
---
sidebar_position: 1
...
## File: docs/restakers/restaking-guides/0-restaking-user-guide/liquid-restaking/_category_.json
````json
{
  "position": 1,
...
## File: docs/restakers/restaking-guides/0-restaking-user-guide/liquid-restaking/restake-lsts.md
````markdown
---
sidebar_position: 1
---
...
## File: docs/restakers/restaking-guides/0-restaking-user-guide/liquid-restaking/withdraw-from-eigenlayer.md
````markdown
---
sidebar_position: 2
---
...
## File: docs/restakers/restaking-guides/0-restaking-user-guide/native-restaking/_category_.json
````json
{
  "position": 2
}
...
## File: docs/restakers/restaking-guides/0-restaking-user-guide/native-restaking/README.md
````markdown
---
sidebar_position: 2
...
## File: docs/restakers/restaking-guides/0-restaking-user-guide/restaker-delegation/_category_.json
````json
{
  "position": 3,
  "label": "Delegation"
...
## File: docs/restakers/restaking-guides/0-restaking-user-guide/restaker-delegation/delegate-to-an-operator.md
````markdown
---
sidebar_position: 1
...
## File: docs/restakers/restaking-guides/0-restaking-user-guide/restaker-delegation/redelegation-process.md
````markdown
---
sidebar_position: 3
...
## File: docs/restakers/restaking-guides/0-restaking-user-guide/restaker-delegation/undelegate-from-an-operator-and-initiate-withdrawal.md
````markdown
---
sidebar_position: 2
...
## File: docs/restakers/restaking-guides/0-restaking-user-guide/_category_.json
````json
{
  "position": 2,
  "label": "Restaking via Web App"
}
````

## File: docs/restakers/restaking-guides/testnet/1-restaking-developer-guide.md
````markdown
---
sidebar_position: 4
...
## File: docs/restakers/restaking-guides/testnet/obtaining-testnet-eth-and-liquid-staking-tokens-lsts.md
````markdown
---
sidebar_position: 2
---
...
## File: docs/restakers/restaking-guides/testnet/README.md
````markdown
---
sidebar_position: 4
...
## File: docs/restakers/restaking-guides/_category_.json
````json
{
  "position": 3,
  "label": "Restaking"
...
## File: docs/restakers/restaking-guides/1-restaking-developer-guide.md
````markdown
---
sidebar_position: 3
...
## File: docs/restakers/_category_.json
````json
{
  "position": 3,
  "label": "Restakers"
